...
Of course with enough effort it can be done - I've played some great D20 Babylon 5. But even there the system was obviously straining, and I feel that game succeeded in spite of the system rather than because of it. By all means use D&D for fantasy (well, don't, but for the other reasons I've given), but as and when you want to expand to other genres (and you should certainly try a variety of genres - otherwise how would you know which you like best?), try a system more appropriate to them.
