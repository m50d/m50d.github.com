...
This one can't be fixed without making the game not-D&D, but can be ignored to a certain extent. As a GM my recommendation is to run D&D the way you would run a diceless game; give the PCs choices to make rather than situations where they need to apply their mechanical skills.
