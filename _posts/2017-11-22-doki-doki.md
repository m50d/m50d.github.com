...
The scripts are in bytecode (`pyc`) form rather than plain in the archive; I could dig out a python decompiler and maybe there'd be some clever obfuscation, but probably not. But at this point I don't even care to try to read the scripts.
