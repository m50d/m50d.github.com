...
Fortunately, using Scala lets me have both OO and functional styles in my toolbox. I've found Shirky's criteria useful when deciding which approach is better a particular business problem; maybe you will too.
<br/>
<p/>
<br/>
