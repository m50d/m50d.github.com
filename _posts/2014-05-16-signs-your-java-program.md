...
I feel obliged to say a few words on complexity, since most Scala discussions seem to end up there. Scala is a consistent language (more so than Java - primitives, arrays and operators are much less of a special case in Scala), but it contains many very general features that can interact . My view is that complexity largely comes from the domain, and the much-maligned Java programmers manage much more complexity than they're given credit for; at one stage or another inner classes, generics, and lambdas were all seen as too complex for Java programmers.
<br/>
<br/>
<br/>
