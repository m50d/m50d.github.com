...
What makes Java compelling isn't the language itself, but the ecosystem around it. Not just in terms of libraries and frameworks, but also tooling: first-class IDEs, debuggers, profilers, monitoring tools.
