...
So Scala may be complex - but it can let you eliminate more complexity elsewhere. Is Scala code more complex than pure, vanilla Java code? Usually yes. Is Scala code more complex than real-world Java code, with the annotations, frameworks and configurations that are needed to address cross-cutting concerns? In my experience, no. Will the implementation of a given set of business requirements be more complex in Scala? That 
<br/>
<br/>
<br/>
