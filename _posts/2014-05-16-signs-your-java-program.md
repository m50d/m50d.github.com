...
(Third-party *types* have to be written carefully, but that's the right tradeoff - it's much more common to pass your own types to a third-party method than to pass a third-party type to your own method).
