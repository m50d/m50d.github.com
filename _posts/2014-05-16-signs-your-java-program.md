...
Contrast this with Scala's spray-routing. A route definition looks rather like a config file (as we might use in, say, [Play](http://www.playframework.com/documentation/1.0/routes)). 
