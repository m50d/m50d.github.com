...
My view is that complexity largely comes from the domain, and the much-maligned Java programmers manage much more complexity than they're given credit for; at one stage or another inner classes, generics, and lambdas were all seen as too complex for Java programmers. When the problems are complex, building the solution out of simple pieces doesn't make it any less complex, and 
<br/>
<br/>
<br/>
