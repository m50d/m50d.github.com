...
C# has a syntactic shortcut for properties with trivial getters; I predict that Java will gain a similar feature in the not too distant future. But data classes in C# are still more verbose than Scala's case classes, and you can use those today.