...
Many enterprise codebases try to solve the problems of the previous section by externalizing part of the program into annotations or XML - Spring or similar for dependency injection, JDBC annotations for managing database transactions, JAXB or Jackson annotations for serialization, some kind of reflection-based AOP system for audit trails or security. And while all these things work, they spoil the very things that make Java great. 
