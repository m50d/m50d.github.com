...
Maybe. If you're using vanilla, unextended Java, and not running into difficulty with the type system, then probably not (at least if you're happy with the level of verbosity). A good barometer might be how you felt about the previous few Java releases - 
