...
````
The casts are repetitive and error-prone (though a good IDE can help with that), and can seem like a code smell. But worse, when we add `Horse`s to our system, our code will silently start to fail.
