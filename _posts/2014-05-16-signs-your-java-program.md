...
What about in a larger codebase, where `Animal`s are part of a library, and the safari team who've created a `Leopard` have no idea that they should be talking to the printing team? In Java you hit the limit here; 