...
The anim&eacute; is only part of the point; this was always meant as a social occasion first, and even a bad show can be the spur to a fun discussion. In some cases it can be a better one - 


 (somewhat diminished by my moving to an area with no restaurants or even pubs - we'd got in the habit of repairing to the local chinese and actually talking)