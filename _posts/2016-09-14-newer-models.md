...
Far less excusable is the proliferation of mobile suit types, which smacks of selling more toys. The difference in models does serve to draw a line between the new arc and its predecessor, but only to the extent that it's used consistently. 