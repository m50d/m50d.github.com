...
The most vital part of job satisfaction is the feeling that one is doing something valuable, something that other people want. For an ivory-tower backend programmer like me who spent today switching our monad stack so that other programmers would get better error messages, it's very easy to lose that connection between your day-to-day work and your value to the business. Estimating and planning with stakeholders puts that value front-and-center
