 ...
 * OCaml... I'm not sure. While I think in many ways it's the best option today, a first-rate concurrency-friendly runtime would require massive investment that's hard to justify when F# and Haskell exist already. 
