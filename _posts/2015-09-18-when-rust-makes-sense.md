...
Finally, performance - especially memory and "space leaks". A lot of these concerns feel overblown, FUDish even - Haskell programs generally perform well, certainly in comparison to Python/Ruby, and 
