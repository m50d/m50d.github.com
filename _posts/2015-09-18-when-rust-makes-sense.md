...
Maybe Rust can be the best language in this space - evidently for some people it already is. I take a rather Whiggish view - I genuinely believe we're converging on the best design for a general-purpose programming language
