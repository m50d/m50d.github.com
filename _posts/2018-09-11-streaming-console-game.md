...
Ultimately, fs2 is very powerful and can lead to simpler, clearer code, as I hope I've demonstrated. But I can't deny that it can be difficult to approach, and I understand avoiding it (particularly in a tutorial aimed at beginners). The time I've put into learning it has paid dividends, and I'd recommend other Scala professionals do the same - but at the moment learning it does represent a substantial commitment. I used to recommend Play's iteratee implementation as a simpler on-ramp to the technique, even if it's ultimately less general and less useful, but I believe that's been removed from current Play versions.