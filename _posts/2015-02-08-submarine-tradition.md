...
*Gundam Seed* is somewhere in between. A few of the details are right - deceleration with the main engines, spaceships that can rotate on a pinhead but struggle to change their linear velocity. A couple of hours is perhaps a plausible timeframe for an orbital rendezvous, 
