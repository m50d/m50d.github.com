...
Scala with Doobie: verbose, generic, safe. This follows the parameterized type approach, so database code can be used fully generically and passed between functions. But 
##Async
##Audit logging
##Custom constructs
