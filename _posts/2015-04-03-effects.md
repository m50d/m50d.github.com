 ...
 * How an effect appears locally in the source code. Some effects are *magic* (that is, completely invisible), in which case most of the other criteria become irrelevant. Some are *concise* and some are *verbose*.
