...
Python, Java using unchecked exceptions, Scala using exceptions, C++: concise, implicit, unsafe. Any function might throw, and exceptions might not be caught.
