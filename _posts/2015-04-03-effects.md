...
#The examples
##Memory management
Java, Python, Scala: magic, implicit. Most languages these days have automatic garbage collection. Most - but by no means all - of the time, performance is acceptable. Any function might allocate or free memory.
