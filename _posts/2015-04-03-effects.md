...
A pure function looks the same in almost any programming language. Where today's programming languages differ is in their handling of *effects*: the parts of the program that aren't just evaluating a formula by substituting a function call with its return value.
