...
The other development that lightens my heart is Scala 2.11's modularization work. Half of Scala's thesis is that a language core should be small but flexible;
...
[2] To me the value of a codebase in a single language is almost self-evident; it's what enables [shared code ownership](http://c2.com/cgi/wiki?CollectiveCodeOwnership), where every 