...
I don't advise anyone to try to write full proofs in Scala. But it's very much possible to encode the most important properties of your program into the type system, even today, and I hope these formal methods stories encourage people to do more of that. I do encourage everyone to play with these more experimental, academic systems - the only way such things become production-ready is as people with the appropriate risk tolerance start to adopt them. But for my money the provably correct development environment of 2025 will look more like Idris than like Java+KeY.