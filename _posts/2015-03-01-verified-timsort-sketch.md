...
In a language with first-class support for type-level programming, a lot of these issues go away; I look forward to seeing an Idris implementation of this problem, and would expect it to be of a similar length to the Java/KeY implementation.